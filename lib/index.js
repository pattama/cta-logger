...
function Logger(dependencies, configuration) {
  ...
  _configuration.name = common.validate(_configuration.name, {type: 'string', optional: true, defaultTo: 'logger'}).output;
  _configuration.properties = common.validate(_configuration.properties, {
    ...
    items: {
      ...
      filename: {optional: true, type: 'string', defaultTo: defaultLogFile},
    },
  }).output;
